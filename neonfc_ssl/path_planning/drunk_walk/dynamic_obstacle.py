...
# Dynamic obstacle: will be considered a circle, so its center and radius will
# be stored along with its speed.
...
class DynamicObstacle(Obstacle):
    ...
    def check_for_collision(
        ...
        # the 2/3 here ended up also being a tunable parameter, dont ask why,
        # please.

        # I will explain anyway, this is due to the f_minus modelage being
        # f_minus=0,
        # if it was kept with the original formula c+(v/|v|)(f_minus+r_dyn),
        # the tail of the virtual obstacle would be always the same, to avoid
        # that this correction move the virtual obstacle a little.

        # pos_dyn = (
        #     self.center
        #     + (self.speed/np.linalg.norm(self.speed))
        #     * ((2 / 3) * r_dyn)
