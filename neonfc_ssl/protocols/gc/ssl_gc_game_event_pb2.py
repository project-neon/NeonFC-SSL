...
_GAMEEVENT_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHALLENGE_FLAG_HANDLED', index=32, number=46,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EMERGENCY_STOP', index=33, number=45,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNSPORTING_BEHAVIOR_MINOR', index=34, number=35,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNSPORTING_BEHAVIOR_MAJOR', index=35, number=36,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PREPARED', index=36, number=1,
      serialized_options=_b('\010\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INDIRECT_GOAL', index=37, number=9,
      serialized_options=_b('\010\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHIPPED_GOAL', index=38, number=10,
      serialized_options=_b('\010\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='KICK_TIMEOUT', index=39, number=12,
      serialized_options=_b('\010\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ATTACKER_TOUCHED_OPPONENT_IN_DEFENSE_AREA', index=40, number=16,
      serialized_options=_b('\010\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ATTACKER_TOUCHED_OPPONENT_IN_DEFENSE_AREA_SKIPPED', index=41, number=40,
      serialized_options=_b('\010\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BOT_CRASH_UNIQUE_SKIPPED', index=42, number=23,
      serialized_options=_b('\010\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BOT_PUSHED_BOT_SKIPPED', index=43, number=25,
      serialized_options=_b('\010\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DEFENDER_IN_DEFENSE_AREA_PARTIALLY', index=44, number=30,
      serialized_options=_b('\010\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MULTIPLE_PLACEMENT_FAILURES', index=45, number=33,
      serialized_options=_b('\010\001'),
      type=None),
  ],
...
_GAMEEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attacker_touched_ball_in_defense_area', full_name='GameEvent.attacker_touched_ball_in_defense_area', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_kicked_ball_too_fast', full_name='GameEvent.bot_kicked_ball_too_fast', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_crash_unique', full_name='GameEvent.bot_crash_unique', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_crash_drawn', full_name='GameEvent.bot_crash_drawn', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='defender_too_close_to_kick_point', full_name='GameEvent.defender_too_close_to_kick_point', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_too_fast_in_stop', full_name='GameEvent.bot_too_fast_in_stop', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_interfered_placement', full_name='GameEvent.bot_interfered_placement', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='possible_goal', full_name='GameEvent.possible_goal', index=22,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='goal', full_name='GameEvent.goal', index=23,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='invalid_goal', full_name='GameEvent.invalid_goal', index=24,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attacker_double_touched_ball', full_name='GameEvent.attacker_double_touched_ball', index=25,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='placement_succeeded', full_name='GameEvent.placement_succeeded', index=26,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='penalty_kick_failed', full_name='GameEvent.penalty_kick_failed', index=27,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='no_progress_in_game', full_name='GameEvent.no_progress_in_game', index=28,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='placement_failed', full_name='GameEvent.placement_failed', index=29,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='multiple_cards', full_name='GameEvent.multiple_cards', index=30,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='multiple_fouls', full_name='GameEvent.multiple_fouls', index=31,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_substitution', full_name='GameEvent.bot_substitution', index=32,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='too_many_robots', full_name='GameEvent.too_many_robots', index=33,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='challenge_flag', full_name='GameEvent.challenge_flag', index=34,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='challenge_flag_handled', full_name='GameEvent.challenge_flag_handled', index=35,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='emergency_stop', full_name='GameEvent.emergency_stop', index=36,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unsporting_behavior_minor', full_name='GameEvent.unsporting_behavior_minor', index=37,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unsporting_behavior_major', full_name='GameEvent.unsporting_behavior_major', index=38,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='prepared', full_name='GameEvent.prepared', index=39,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='indirect_goal', full_name='GameEvent.indirect_goal', index=40,
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chipped_goal', full_name='GameEvent.chipped_goal', index=41,
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kick_timeout', full_name='GameEvent.kick_timeout', index=42,
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attacker_touched_opponent_in_defense_area', full_name='GameEvent.attacker_touched_opponent_in_defense_area', index=43,
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attacker_touched_opponent_in_defense_area_skipped', full_name='GameEvent.attacker_touched_opponent_in_defense_area_skipped', index=44,
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_crash_unique_skipped', full_name='GameEvent.bot_crash_unique_skipped', index=45,
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_pushed_bot_skipped', full_name='GameEvent.bot_pushed_bot_skipped', index=46,
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='defender_in_defense_area_partially', full_name='GameEvent.defender_in_defense_area_partially', index=47,
      ...
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='multiple_placement_failures', full_name='GameEvent.multiple_placement_failures', index=48,
